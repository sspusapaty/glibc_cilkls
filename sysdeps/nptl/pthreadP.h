...
extern void *__cilk_worker_getspecific (pthread_key_t key);
libc_hidden_proto (__cilk_worker_getspecific)
extern int __pthread_setspecific (pthread_key_t key, const void *value);
libc_hidden_proto (__pthread_setspecific)
extern int __cilk_worker_setspecific (pthread_key_t key, const void *value);
libc_hidden_proto (__cilk_worker_setspecific)
