...
versioned_symbol (libc, ___cilk_worker_getspecific, cilk_worker_getspecific,
		  GLIBC_2_34);
libc_hidden_ver (___cilk_worker_getspecific, __cilk_worker_getspecific)
#ifndef SHARED
strong_alias (___cilk_worker_getspecific, __cilk_worker_getspecific)
#endif

#if OTHER_SHLIB_COMPAT (libc, GLIBC_2_0, GLIBC_2_34)
compat_symbol (libpthread, ___cilk_worker_getspecific, __cilk_worker_getspecific,
	       GLIBC_2_0);
compat_symbol (libpthread, ___cilk_worker_getspecific, cilk_worker_getspecific,
	       GLIBC_2_0);
#endif
